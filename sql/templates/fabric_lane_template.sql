...
-------------------------------
DROP VIEW IF EXISTS mv_kafka_to_raw_${SOURCE}_${STREAM};
DROP TABLE IF EXISTS kafka_${SOURCE}_${STREAM};

DROP VIEW IF EXISTS mv_raw_to_parsed_${SOURCE}_${STREAM};
DROP TABLE IF EXISTS parsed_${SOURCE}_${STREAM};
DROP TABLE IF EXISTS raw_${SOURCE}_${STREAM};
...
DROP VIEW IF EXISTS mv_parsed_to_fact_order_failures_minute_${SOURCE}_${STREAM};
DROP TABLE IF EXISTS fact_order_failures_minute_${SOURCE}_${STREAM};

DROP VIEW IF EXISTS mv_parsed_to_fact_jira_start_hour_${SOURCE}_${STREAM};
DROP TABLE IF EXISTS fact_jira_start_hour_${SOURCE}_${STREAM};
...
DROP VIEW IF EXISTS mv_order_failures_minute_${SOURCE}_${STREAM}_to_all;
DROP VIEW IF EXISTS mv_jira_start_hour_${SOURCE}_${STREAM}_to_all;
...
SETTINGS
  ...
  kafka_group_name    = 'fabric_${SOURCE}_${STREAM}',
...
-----------------------------
CREATE TABLE IF NOT EXISTS raw_${SOURCE}_${STREAM}
(
...
CREATE MATERIALIZED VIEW mv_kafka_to_raw_${SOURCE}_${STREAM}
TO raw_${SOURCE}_${STREAM}
AS
SELECT
  _topic     AS topic,
...
-- RAW → PARSED
CREATE MATERIALIZED VIEW mv_raw_to_parsed_${SOURCE}_${STREAM}
TO parsed_${SOURCE}_${STREAM}
AS
SELECT
...
/*
CREATE TABLE IF NOT EXISTS fact_order_failures_minute_${SOURCE}_${STREAM}
(
  t_min DateTime,
  ns LowCardinality(String),
  c UInt64
...
CREATE MATERIALIZED VIEW mv_parsed_to_fact_order_failures_minute_${SOURCE}_${STREAM}
TO fact_order_failures_minute_${SOURCE}_${STREAM} AS
SELECT
  toStartOfMinute(ts_ingest) AS t_min,
  ns,
  count() AS c
...
/*
CREATE TABLE IF NOT EXISTS fact_jira_start_hour_${SOURCE}_${STREAM}
(
  t_hour DateTime,
  ns LowCardinality(String),
  c UInt64
...
CREATE MATERIALIZED VIEW mv_parsed_to_fact_jira_start_hour_${SOURCE}_${STREAM}
TO fact_jira_start_hour_${SOURCE}_${STREAM} AS
SELECT
...
/*
CREATE MATERIALIZED VIEW mv_order_failures_minute_${SOURCE}_${STREAM}_to_all
TO fact_order_failures_minute_all AS
SELECT t_min, ns, c, '${SOURCE}_${STREAM}' AS lane
FROM fact_order_failures_minute_${SOURCE}_${STREAM};

CREATE MATERIALIZED VIEW mv_jira_start_hour_${SOURCE}_${STREAM}_to_all
TO fact_jira_start_hour_all AS
SELECT t_hour, ns, c, '${SOURCE}_${STREAM}' AS lane
FROM fact_jira_start_hour_${SOURCE}_${STREAM};
*/
